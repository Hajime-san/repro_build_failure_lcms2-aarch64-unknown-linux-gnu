// https://github.com/kornelski/rust-lcms2/blob/99805e551e03e634f0667afeb794452edfb82f9f/examples/gamma.rs
use lcms2::*;
...
fn main() {
  ...
  let custom_profile = Profile::new_rgb(
    CIExyY::d50(),
    &custom_primaries,
    &[custom_gamma, custom_gamma, custom_gamma],
  )
  .unwrap();
